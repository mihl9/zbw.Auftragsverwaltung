...
{
    public static class UserIdentityMigrator
    {
        public static IApplicationBuilder MigrateUserIdentityDatabase(this IApplicationBuilder builder)
        {
            using var scope = builder.ApplicationServices.CreateScope();
            var ctx = scope.ServiceProvider.GetRequiredService<UserIdentityContext>();
