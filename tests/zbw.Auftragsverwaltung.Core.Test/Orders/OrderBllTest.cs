...
namespace zbw.Auftragsverwaltung.Core.Test.Orders
{
    public class OrderBllTest
    {
        ...
        {
            var orderDto = new OrderDto() { CustomerId = Guid.NewGuid(), OrderNr = 3, Date = new DateTime(2008,11,20), Id = GuidCollection.Id001 };
        ...
        {
            var orderDto = new OrderDto() { CustomerId = Guid.NewGuid(), OrderNr = 3, Date = new DateTime(2017,03,15), Id = GuidCollection.Id003 };
        ...
        {
            var orderDto = new OrderDto(){ CustomerId = Guid.NewGuid(), OrderNr = 2, Date = new DateTime(2017,04,15), Id = GuidCollection.Id002};
